                            ...
                            <div class="featured-flat">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="flat-item">
                                            <div class="flat-item-image">
                                                <a href="properties-details.html"><img src="images/tailieu1.jpg" alt=""></a>
                                                <div class="flat-link">
                                                    <a href="properties-details.html">Chi tiết</a>
                                                </div>
                                                <ul class="flat-desc">
                                                    <li style="width: 80%">
                                                        <div class="row">
                                                            <div class="col-md-4" style="float left">
                                                                <span class="glyphicon glyphicon-list-alt"> 9/20/18</span>
                                                            </div>
                                                            <div class="col-md-4">
                                            ...
                                            <div class="flat-item-info">
                                                <div class="flat-title-price">
                                                    <h5><a href="properties-details.html">Tài Liệu Thi Tiếng Anh  </a></h5>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="flat-item">
                                            <div class="flat-item-image">
                                                <a href="vanban.html"><img src="images/tailieu2.jpg" alt=""></a>
                                                <div class="flat-link">
                                                    <a href="vanban.html">Chi tiết</a>
                                                </div>
                                                <ul class="flat-desc">
                                                    <li style="width: 80%">
                                                        <div class="row">
                                            ...
                                            <div class="flat-item-info">
                                                <div class="flat-title-price">
                                                    <h5><a href="properties-details.html">Đề Thi Toán Quốc Gia năm 2015</a></h5>
                                                    <button type="button" class="btn btn-default btn-sm" style="float:right">
                                                      <span class="glyphicon glyphicon-download-alt" ></span> Download
                                                    </button>
                                                </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="flat-item">
                                            ...
                                            <div class="flat-item-info">
                                                <div class="flat-title-price">
                                                    <h5><a href="properties-details.html">Sử dụng rừng thông minh </a></h5>
                                                    <button type="button" class="btn btn-default btn-sm" style="float:right">
                                                      <span class="glyphicon glyphicon-download-alt"></span> Download
                                                    </button>
                                                </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="flat-item">
                                            <div class="flat-item-image">
                                                <a href="properties-details.html"><img src="images/tailieu2.jpg" alt=""></a>
                                                <div class="flat-link">
                                                    <a href="properties-details.html">Chi tiết</a>
                                                </div>
                                                <ul class="flat-desc">
